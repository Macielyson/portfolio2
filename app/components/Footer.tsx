      ...
      <div className="container mx-auto px-6 py-12 relative z-10">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            <a
              href="#home"
              className="text-2xl font-bold font-space-grotesk bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent mb-4 inline-block"
            >
              &lt;Macielyson/&gt;
            </a>
            <p className="text-gray-400 max-w-md leading-relaxed">
              Desenvolvedor FullStack apaixonado por criar experiências digitais
              extraordinárias com tecnologias modernas e código limpo.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {["Início", "Skills", "Projetos", "Contato"].map((item) => (
                <li key={item}>
                  <a
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} Macielyson Nascimento. Todos os direitos reservados.
          </p>
