...
const experiencias = [
  {
    ...
    descricao:
      "Lidero o desenvolvimento de aplicações web escaláveis usando React, Node.js e AWS. Implementei microserviços que melhoraram a performance em 40%.",
  ...
  },
  {
    ...
    periodo: "2021 - 2022",
    descricao:
      "Desenvolvi interfaces modernas e responsivas, colaborando com equipes de UX/UI. Reduzi o tempo de carregamento em 60% através de otimizações.",
  ...
  },
  {
    ...
    periodo: "2020 - 2021",
    descricao:
      "Trabalhei com diversos clientes desenvolvendo soluções personalizadas, desde e-commerces até sistemas de gestão interna.",
  ...
  },
  {
    ...
    periodo: "2020",
    descricao:
      "Imersão de 6 meses em desenvolvimento web, com foco em JavaScript, React, Node.js e metodologias ágeis.",
  ...
  },
  {
    ...
    periodo: "2017 - 2021",
    descricao:
      "Formação com foco em algoritmos, estrutura de dados, arquitetura de software e engenharia de computação.",
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Minha jornada profissional e acadêmica em desenvolvimento de
            software
          </p>
